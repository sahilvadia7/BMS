...
public class BranchController {
        ...
        @Operation(summary = "Create a new branch", description = "Creates a new branch with name, address, and status. Access: Admin", responses = {
                        @ApiResponse(responseCode = "200", description = "Branch created successfully", content = @Content(schema = @Schema(implementation = BranchResponseDto.class))),
        ...
        @Operation(summary = "Update an existing branch", description = "Updates branch details by branch ID. Access: Admin", responses = {
                        @ApiResponse(responseCode = "200", description = "Branch updated successfully", content = @Content(schema = @Schema(implementation = BranchResponseDto.class))),
        ...
        @Operation(summary = "Get branch by ID", description = "Fetch branch details by its ID. Access: Public/Internal", responses = {
                        @ApiResponse(responseCode = "200", description = "Branch found", content = @Content(schema = @Schema(implementation = BranchResponseDto.class))),
                        @ApiResponse(responseCode = "404", description = "Branch not found")
        })
        @GetMapping("/{branchId}")
        ...
        @Operation(summary = "Get all branches", description = "Retrieves all branches, optionally filtering only active ones. Access: Public/Internal", responses = {
                        @ApiResponse(responseCode = "200", description = "List of branches", content = @Content(schema = @Schema(implementation = BranchResponseDto.class)))
        })
        @GetMapping
        public ResponseEntity<List<BranchResponseDto>> getAllBranches(
                        @Parameter(description = "Whether to return only active branches") @RequestParam(defaultValue = "true") boolean onlyActive) {
        ...
        //
        // BranchResponseDto updatedBranch =
        // branchService.createAndAssignEmployee(branchId, registerRequest);
        ...
        // @ApiResponse(responseCode = "404", description = "Branch not found or
        // employee invalid")
        // }
        // )
        ...
        // BranchResponseDto response = branchService.addEmployeeToBranch(branchId,
        // employeeId);
        // return ResponseEntity.ok(response);
        // }
        //
        ...
        // content = @Content(schema = @Schema(implementation =
        // BranchResponseDto.class))),
        // @ApiResponse(responseCode = "404", description = "Branch or employee not
        // found")
        // }
        // )
        ...
        // @Parameter(description = "Branch ID") @PathVariable Long branchId,
        // @Parameter(description = "Employee ID") @PathVariable Long employeeId) {
        // BranchResponseDto response = branchService.removeEmployeeFromBranch(branchId,
        // employeeId);
        // return ResponseEntity.ok(response);
        // }
        //
        ...
        @Operation(summary = "Check if branch exists", description = "Verifies if a branch exists by its ID", responses = {
        ...
        // getBranchEmployeeDetails(@PathVariable Long branchId) {
        // List<EmployeeDto> employees =
        // branchService.getBranchEmployeeDetails(branchId);
        // return ResponseEntity.ok(employees);
        // }
